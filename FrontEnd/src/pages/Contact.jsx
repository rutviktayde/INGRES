  ...
  const faqs = [
    {
      ...
      answer:
        "Simply start a conversation with Jal Sathi and ask about your specific location. The AI will fetch real-time data from the INGRES database.",
    },
    {
      question: "Is the data provided by Jal Sathi official and reliable?",
      answer:
        "Yes, all data comes directly from the official INGRES database maintained by CGWB and IIT Hyderabad, ensuring accuracy and reliability.",
    },
    {
      question: "Can I export charts and visualizations?",
      answer:
        "Absolutely! You can download any generated charts, maps, or visual insights for your reports and presentations.",
    },
    {
      question: "Does Jal Sathi support regional languages?",
      answer:
        "Yes, Jal Sathi supports multiple Indian regional languages along with English for wider accessibility.",
    },
    {
      question: "How often is the groundwater data updated?",
      answer:
        "The data is updated annually as part of the Assessment of Dynamic Ground Water Resources of India conducted by CGWB.",
    },
  ];
